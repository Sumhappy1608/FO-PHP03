...
$query_two_posts = "SELECT p.*,c.Title as 'categories' FROM posts p LEFT JOIN categories c ON p.Category_id = c.ID WHERE p.STATUS = 1 ORDER BY p.Created_at DESC limit 2";
				...
				<div class="row">	
					...
					<div class="col-md-6">
						<div class="post post-thumb">
							<a class="post-img" href="blog-post.php?ID=<?= $post['ID'] ?>"><img src="<?= $post['Thumbnail'] ?>" alt="" height="350px"></a>
							<div class="post-body">
								<div class="post-meta">
									<a class="post-category cat-2" href="category.html"><?= $post['categories'] ?></a>
